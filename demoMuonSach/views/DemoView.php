    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Danh sách sách</h3>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <a class="btn btn-info btn-min-width mr-1 mb-1" style="margin-left: 1000px;" href="index.php?controller=demomuonsach&action=showBook">Giỏ sách</a>
                        </div>
                        <div class="card-content collapse show">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Giá</th>
                                            <th scope="col">Số lượng muốn mượn</th>
                                            <th scope="col"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($data as $key => $row) : ?>
                                            <tr>
                                                ...
                                                <td scope = "row">
                                                    <input class="form-control input-number" value="1" min="1" max="<?php echo $row->remaining ?>" id="quantity<?php echo $row->id; ?>" type="number" style="width: 80px;margin-left: 30px">
                                                </td>

                                                <td scope = "row">
                                                    <a class="btn btn-success" style="color: white" onclick="addToCart<?php echo $row->id ?>()" href="#">Thêm vào giỏ sách</a>&nbsp;
                                                </td>
                                            </tr>
                                            <script>
                                                function addToCart<?php echo $row->id ?>() {
                                                    var quantity = document.getElementById('quantity<?php echo $row->id; ?>').value;
                                                    location.href = "index.php?controller=demomuonsach&action=addToCart&id=<?php echo $row->id; ?>&quantity<?php echo $row->id; ?>=" + quantity;
                                                }
                                            </script>
                                        <?php endforeach; ?>
                                    </tbody>
                            ...
                            <div class="navigation-background" style="margin-left: 979px;">
                                <ul class="pagination">
                                    ...
                                    <?php for ($i = 1; $i <= $numPage; $i++) : ?>
                                        <li>
                                            <a class="page-link" href="index.php?controller=demomuonsach&p=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
                                </ul>
                            </div>
