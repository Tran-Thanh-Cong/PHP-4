                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col"><?php echo $student->studentCode; ?></td>
                                    </tr>                                  
                                    <tr>
                                    ...
                                    <tr>
                                        <th scope="col">Lớp</th>
                                        <td scope="col"><?php echo $student->studentClass; ?></td>
                                    </tr>     
                                    <tr>
                                        <th scope="col">Số điện thoại</th>
                                        <td scope="col"><?php echo $student->phoneNumber; ?></td>
                                    </tr>  
                                    <tr>
                                        <th scope="col">Ngày mượn</th>
                                        <td scope="col"><?php echo $student->dateOfBookkingBook; ?></td>
                                    </tr>      
                                </table>
                            </div>
                        </div>
