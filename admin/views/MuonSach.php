    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Trả sách</h3>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Danh sách mượn</h4>
                                    ...
                                    <tbody>
                                        <?php foreach($data as $rows): ?>
                                            <?php 
                                                ...
                                                $muon_sach = $this->getTra_Sach($rows->order_id);  
                                                $product = $this->getProduct($rows->product_id); 
                                                $student = $this->getStudent($muon_sach->student_id);       
                                            ?>
                                            <tr>
                                                <td scope="row"><?php echo $product->name; ?></td>
                                                <td scope="row"><?php echo $product->price; ?></td>
                                                <td scope="row"><?php echo $rows->quantity; ?></td>
                                                <td scope="row"><?php echo $muon_sach->date; ?></td>
                                                <td scope="row"><?php echo $student->studentName; ?></td>
                                                <td>
                                                    <a class="btn btn-primary" href="index.php?controller=statusbook&action=tra_sach&id=<?php echo $rows->id; ?>">Trả sách</a>&nbsp;
                                                </td>     
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
