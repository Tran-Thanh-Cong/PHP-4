    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Danh sách các loại sách</h3>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Quản lý loại sách</h4>
                        ...
                        <div class="card-content collapse show">
                            <a class="btn btn-info btn-min-width mr-1 mb-1" style="margin-left: 1000px;" href="index.php?controller=category&action=create">Thêm loại sách</a>
                        </div>
                        <div class="card-content collapse show">
                                    ...
                                    <tbody>
                                        <?php foreach ($data as $key => $row): ?>
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <a class="btn btn-success" href="index.php?controller=category&action=update&id=<?php echo $row->id; ?>">EDIT</a>&nbsp;
                                                    <a class="btn btn-danger" href="index.php?controller=category&action=delete&id=<?php echo $row->id; ?>" onclick="return window.confirm('Ban co muon xoa?');">DELETE</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                            ...
                            <div class="navigation-background" style="margin-left: 573px;">
                                <ul class="pagination">
                                    ...
                                    <?php for($i = 1;$i <= $numPage; $i++): ?>
                                        <li>
                                            <a class="page-link" href="index.php?controller=category&p=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
                                </ul>
                            </div>
