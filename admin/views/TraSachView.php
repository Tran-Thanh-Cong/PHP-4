                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Danh sách trả sách</h4>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach($data as $rows): ?>
                                            <tr>
                                                <td scope="row"><?php echo $rows->product_name; ?></td>
                                                <td scope="row"><?php echo $rows->product_price; ?></td>
                                                <td scope="row"><?php echo $rows->quantity; ?></td>
                                                <td scope="row"><?php echo $rows->order_date; ?></td>
                                                <td scope="row"><?php echo $rows->student_name; ?></td>
                                                <td scope="row"><?php echo $rows->total_price; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
