    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Báo cáo thống kê</h3>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <input type="submit" value="tra cứu thông kê" class="btn btn-primary" style="margin-left: 200px;"/>
                                </form>
                            </div>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Số lượng sách cho mượn</th>
                                            <th scope="col">Tổng số sinh viên mượn sách</th>
                                        </tr>
                                    </thead>
                                    <tbody>
