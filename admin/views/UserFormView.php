    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Thêm/Sửa tài khoản Admin</h3>
            </div>
                                    ...
                                    <form class="form" method="POST" action="<?php echo $action; ?>">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="donationinput2" class="form-control" <?php if(isset($record->email)): ?> placeholder="Không đổi password thì không nhập"<?php else: ?> required <?php endif; ?> name="password">
                                            </div>
                                        </div>
