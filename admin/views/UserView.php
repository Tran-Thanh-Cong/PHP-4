                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <a class="btn btn-info btn-min-width mr-1 mb-1" style="margin-left: 1000px;" href="index.php?controller=user&action=create">Thêm tài khoản</a>
                        </div>
                        <div class="card-content collapse show">
                                    ...
                                    <tbody>
                                        <?php foreach ($data as $row) : ?>
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <a class="btn btn-success" href="index.php?controller=user&action=update&id=<?php echo $row->id; ?>">EDIT</a>&nbsp;
                                                    <a class="btn btn-danger" href="index.php?controller=user&action=delete&id=<?php echo $row->id; ?>" onclick="return window.confirm('Ban co muon xoa?');">DELETE</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                            ...
                            <div class="navigation-background" style="margin-left: 900px;">
                                <ul class="pagination">
                                    ...
                                    <?php for($i = 1;$i <= $numPage; $i++): ?>
                                        <li>
                                            <a class="page-link" href="index.php?controller=user&p=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
                                </ul>
                            </div>
