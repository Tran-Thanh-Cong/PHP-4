    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Thêm/Sửa sinh viên</h3>
            </div>
                ...
                <div class="row match-height">
                    <div class="col-xl-6 col-md-12">
                        <?php if(isset($_GET["notify"]) && $_GET["notify"] == "emailExists"): ?>
                    		<div class="alert alert-warning" style="width: 1200px">Email đã tồn tại</div>
                    	<?php endif; ?>
                                    ...
                                    <form class="form" method="POST" action="<?php echo $action; ?>">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label for="donationinput1" >Tên sinh viên</label>
                                                <input type="text" id="donationinput1" class="form-control" value="<?php echo isset($record->studentName) ? $record->studentName :''; ?>" name="student_name" required required>
                                            </div>
                                            <div class="form-group">
                                                <label for="donationinput2" >Mã sinh viên</label>
                                                <input type="text" id="donationinput2" class="form-control" value="<?php echo isset($record->studentCode) ? $record->studentCode :''; ?>" name="student_code" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="donationinput2" >Giới tính</label>
                                                <input type="text" id="donationinput2" class="form-control" value="<?php echo isset($record->gender) ? $record->gender :''; ?>" name="gender" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="donationinput2" >Lớp</label>
                                                <input type="text" id="donationinput2" class="form-control" value="<?php echo isset($record->studentClass) ? $record->studentClass :''; ?>" name="student_class" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="donationinput2" >Số điện thoại</label>
                                                <input type="text" id="donationinput2" class="form-control" value="<?php echo isset($record->phoneNumber) ? $record->phoneNumber :''; ?>" name="phone_number" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="donationinput2" >Ngày mượn</label>
                                                <input type="date" id="donationinput2" class="form-control" value="<?php echo isset($record->dateOfBookkingBook) ? $record->dateOfBookkingBook :''; ?>" name="ngay_muon" required>
                                            </div>
                                        </div>
