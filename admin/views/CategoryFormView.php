    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Thêm/Sửa loại sách</h3>
            </div>
                                    ...
                                    <form class="form" method="POST" action="<?php echo $action; ?>">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label for="donationinput1" >Tên loại sách</label>
                                                <input type="text" id="donationinput1" class="form-control" value="<?php echo isset($record->name) ? $record->name : '' ?>" name="name" required>
                                            </div>
                                        </div>
