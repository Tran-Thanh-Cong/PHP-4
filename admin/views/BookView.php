                ...
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="nav-item dropdown navbar-search"><a class="nav-link dropdown-toggle hide" data-toggle="dropdown" href="#"><i class="ficon ft-search"></i></a>
                        <ul class="dropdown-menu">
                            <li class="arrow_box">
                                <form method="post" action="index.php?controller=book&action=search">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Book</h3>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <a class="btn btn-info btn-min-width mr-1 mb-1" style="margin-left: 1000px;" href="index.php?controller=book&action=create">Thêm sách</a>
                        </div>
                        <div class="card-content collapse show">
                                    ...
                                    <tbody>
                                        <?php foreach ($data as $key => $row): ?>
                                            <tr>
                                                ...
                                                <td scope="row"><?php echo $row->bookCode; ?></td>
                                                <td scope="row"><?php echo $row->remaining; ?></td>
                                                <td scope = row><a href="index.php?controller=book&action=detail&id=<?php echo $row->id; ?>">Chi tiết sách</a></td>
                                                <td scope="row">
                                                    <a class="btn btn-success" href="index.php?controller=book&action=update&id=<?php echo $row->id; ?>">EDIT</a>&nbsp;
                                                    <a class="btn btn-danger" href="index.php?controller=book&action=delete&id=<?php echo $row->id; ?>" onclick="return window.confirm('Ban co muon xoa?');">DELETE</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                            ...
                            <div class="navigation-background" style="margin-left: 929px;">
                                <ul class="pagination">
                                    ...
                                    <?php for($i = 1;$i <= $numPage; $i++): ?>
                                        <li>
                                            <a class="page-link" href="index.php?controller=book&p=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
                                </ul>
                            </div>
